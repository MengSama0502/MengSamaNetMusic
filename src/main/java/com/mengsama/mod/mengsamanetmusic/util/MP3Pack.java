...
import net.fabricmc.fabric.ModList;
...
public class MP3Pack implements RepositorySource {
    ...
    public MP3Pack() {
        ...
        pack = Pack.create("mengsamanetmusic_mp3_pack",
                Component.translatable("title.mengsamanetmusic.mp3"),
                false, supplier,
                new Pack.Info(Component.translatable("description.mengsamanetmusic.mp3"),
    ...
    private net.minecraftforge.resource.PathPackResources getLegacyPack() {
        final IModFile file = ModList.get().getModFileById("mengsamanetmusic").getFile();
