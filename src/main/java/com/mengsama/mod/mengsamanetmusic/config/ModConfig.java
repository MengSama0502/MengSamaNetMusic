...
import net.minecraftforge.common.net.fabricmc.fabric;

import java.net.Proxy;

public class ModConfig {

    public static net.fabricmc.fabric.BooleanValue ENABLE_STEREO;
    public static net.fabricmc.fabric.EnumValue<Proxy.Type> PROXY_TYPE;
    public static net.fabricmc.fabric.ConfigValue<String> PROXY_ADDRESS;

    public static net.fabricmc.fabric.BooleanValue ENABLE_PLAYER_LYRICS;
    public static net.fabricmc.fabric.BooleanValue ENABLE_MAID_LYRICS;
    public static net.fabricmc.fabric.ConfigValue<String> ORIGINAL_PLAYER_LYRICS_COLOR;
    public static net.fabricmc.fabric.ConfigValue<String> TRANSLATED_PLAYER_LYRICS_COLOR;
    public static net.fabricmc.fabric.ConfigValue<String> ORIGINAL_MAID_LYRICS_COLOR;
    public static net.fabricmc.fabric.ConfigValue<String> TRANSLATED_MAID_LYRICS_COLOR;

    public static net.fabricmc.fabric.BooleanValue ENABLE_NETMUSIC_CD_GENERATION;
    public static net.fabricmc.fabric.BooleanValue ENABLE_VIP_NETMUSIC_CD_GENERATION;

    public static net.fabricmc.fabric.ConfigValue<String> NET_EASE_COOKIE;
    public static net.fabricmc.fabric.ConfigValue<String> NET_EASE_MUSIC_LEVEL;

    public static net.fabricmc.fabric.ConfigValue<String> MUSIC_PROVIDER;
    public static net.fabricmc.fabric.ConfigValue<String> QQ_VIP_COOKIE;
    public static net.fabricmc.fabric.ConfigValue<String> MUSIC_QUALITY;

    public static net.fabricmc.fabric.BooleanValue DEBUG_MODE;
    public static net.fabricmc.fabric.BooleanValue ENABLE_MUSIC_HUD;
    public static net.fabricmc.fabric.IntValue MUSIC_HUD_X;
    public static net.fabricmc.fabric.IntValue MUSIC_HUD_Y;

    public static net.fabricmc.fabric init() {
        net.fabricmc.fabric.Builder builder = new net.fabricmc.fabric.Builder();
