...
import net.minecraftforge.common.net.neoforged.neoforge.common.ModConfigSpec;

import java.net.Proxy;

public class ModConfig {

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue ENABLE_STEREO;
    public static net.neoforged.neoforge.common.ModConfigSpec.EnumValue<Proxy.Type> PROXY_TYPE;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> PROXY_ADDRESS;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue ENABLE_PLAYER_LYRICS;
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue ENABLE_MAID_LYRICS;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> ORIGINAL_PLAYER_LYRICS_COLOR;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> TRANSLATED_PLAYER_LYRICS_COLOR;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> ORIGINAL_MAID_LYRICS_COLOR;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> TRANSLATED_MAID_LYRICS_COLOR;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue ENABLE_NETMUSIC_CD_GENERATION;
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue ENABLE_VIP_NETMUSIC_CD_GENERATION;

    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> NET_EASE_COOKIE;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> NET_EASE_MUSIC_LEVEL;

    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> MUSIC_PROVIDER;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> QQ_VIP_COOKIE;
    public static net.neoforged.neoforge.common.ModConfigSpec.ConfigValue<String> MUSIC_QUALITY;

    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue DEBUG_MODE;
    public static net.neoforged.neoforge.common.ModConfigSpec.BooleanValue ENABLE_MUSIC_HUD;
    public static net.neoforged.neoforge.common.ModConfigSpec.IntValue MUSIC_HUD_X;
    public static net.neoforged.neoforge.common.ModConfigSpec.IntValue MUSIC_HUD_Y;

    public static net.neoforged.neoforge.common.ModConfigSpec init() {
