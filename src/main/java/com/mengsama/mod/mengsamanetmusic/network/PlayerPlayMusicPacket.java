        ...
        mc.submitAsync(() -> {
            try {
                ...
                if (player != null) {
                    ...
                    com.mengsama.mod.mengsamanetmusic.hud.MusicInfoHud.setInfoFromPacket(packet.info);
                }
            } catch (MalformedURLException ignored) {
            } catch (Exception e) {
                com.mengsama.mod.mengsamanetmusic.MengSamaNetMusic.LOGGER.error("PlayerPlayMusicPacket handleClient error: {}", e.getMessage());
            }
        });
    }

    @OnlyIn(Dist.CLIENT)
    private static void stopExistingPlayerMusic() {
        try {
            ...
            for (var sound : sounds) {
                ...
                } else if (sound instanceof com.mengsama.mod.mengsamanetmusic.util.NetMusicSound netSound) {
                    netSound.stopSound();
                }
            }
        } catch (Exception ignored) {}
